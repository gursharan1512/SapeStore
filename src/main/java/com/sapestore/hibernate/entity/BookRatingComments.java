...
@NamedQueries(value = {
    ...
    @NamedQuery(name = "BookRatingComments.findByIsbn", query = "from BookRatingComments b where b.isbn = :isbn") })
public class BookRatingComments implements Serializable {
  ...
  @SequenceGenerator(name = "commentId", sequenceName = "SEQ_COMMENT_ID", initialValue = 200, allocationSize = 1)
