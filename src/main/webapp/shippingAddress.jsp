...
<title>SapeStore-ShippingAddress</title>
	...
	<div id="wrapper">
		...
		<div id="mainContent">
			...
			<table cellpadding="10">
				<form:form method="post" onsubmit="return checkFields()"
					action="addOrderDetailsToDb" id="addAddress"
					commandName="shippingAddressVo">
					<fieldset>
						<tr>
							<div>
								<td><label for="name">Customer Name <span
						...
						<tr>
							<div>
								<td><label for="addressLine1">Address Line 1<span
										class="required">*</span></label></td>
								<td><input type="text" placeholder="address"
									required="Please provide address" name="addressLine1"
									id="addressLine1" value="${customeraddress.addressLine1}" /></td>
						...
						<tr>
							<div>
								...
								<td><input type="text" placeholder="address"
									name="addressLine2" value="${customeraddress.addressLine2}" /></td>
								<form:errors path="addressLine2" cssClass="error" />
							</div>
						</tr>
						<tr>
							<div>
								<td><label for="stateName">State <span
										class="required">*</span></label></td>
								...
								<td><select name="stateId" id="stateName"
									onchange="populateCity(this.value)">
										...
										<c:forEach items="${stateList}" var="current">
											<c:choose>
												<c:when test="${current.stateId == customeraddress.stateId}">
													<option value="${current.stateId}" selected="selected">${current.stateName}</option>
												</c:when>
												<c:otherwise>
								...
								<td><input type="text" name="name"
									value="Please Provide State" disabled="disabled" id="stateN"
									style="background-color: #DFE5E6; color: red; border: none; display: none;" /></td>
								<td><form:errors path="stateId" cssClass="error" /></td>
							</div>
						</tr>
						<tr>
							<td><label for="cityName">City <span
									class="required">*</span></label></td>
							<td><div id="populateCity">
									<select name="cityId" id="cityname">
										<option value="0">Select Your City</option>
									</select>
								</div></td>
							<td><input type="text" name="name"
								value="please provide City" disabled="disabled" id="cityN"
								style="background-color: #DFE5E6; color: red; border: none; display: none;" /></td>
							<td><form:errors path="cityId" cssClass="error" /></td>
						</tr>
						<div id="secret" style="display: none;">
							<input type="text" name="secretcity" id="secretcity"
								value="${customeraddress.cityId}" />
						</div>
						<tr>
							<div>
								<td><label for="postalCode">Zipcode <span
										class="required">*</span></label></td>
								<td><input type="text" placeholder="" id="zipCode"
									required="Please provide zipcode" name="postalCode"
									value="${customeraddress.postalCode}" maxlength="5" /></td>
								<td><input type="text" name="name" value="Zip error"
									disabled="disabled" id="zipcodeError"
									style="background-color: #DFE5E6; color: red; border: none; display: none;" /></td>
						...
						<tr>
							<div>
								...
								<td><input type="text" placeholder="" name="phone"
									id="phoneNo" value="${user.phone}" /></td>
								<td><input type="text" name="name" value="Phone Error"
									disabled="disabled" id="phoneError"
									style="background-color: #DFE5E6; color: red; border: none; display: none;" /></td>
						...
						<tr>
							<div>
								...
								<td><input type="text" placeholder="" name="mobileNumber"
									id="mobileNo" value="${user.mobileNumber}" /></td>
								<td><input type="text" name="name" value="Mobile Error"
									disabled="disabled" id="mobileError"
									style="background-color: #DFE5E6; color: red; border: none; display: none;" /></td>
						...
						<tr>
							<td><input type="submit" value="Save & Continue"
								class="lightButton addtoStore"></td>
						</tr>
					</fieldset>
