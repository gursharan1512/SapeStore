...
<div id="wrapper"> 
  ...
  <div id="mainContent">
   ...
   <p>
   <h4>
		The application is down due to maintenance purpose. Please contact the administrator for the resolution of the issue. 
		Click <a href="/SapeStore/welcome?checkMe=false" >HOME</a> to browse books.
   </h4>
   </p>
  </div>
