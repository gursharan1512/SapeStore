...
<div id="wrapper"> 
  <!-- header starts-->
  <header>
    <div id="header"> <a href="/SapeStore/welcome?checkMe=${checkMe}" title="SapeStore" class="logo"><img src="img/logo.jpg" width="231" height="109" alt="SapeStore"></a>
      <nav>
        <ul class="nav">
          <li class="active"><a href="/SapeStore/welcome.action" >HOME</a></li>
        </ul>
      </nav>
    </div>
  </header>
  ...
  <div id="mainContent">
   ...
   <h4>
		${errorMessage} <br><br>
		Please Click <a href="/SapeStore/welcome?checkMe=false" >HOME</a> to browse books.
   </h4>
   </p>
  </div>
