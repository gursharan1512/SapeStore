			...
			<div id="wrapper" class="homeAdmin">
				...
				<header>
					<div id="header">
						...
						<nav>
							<ul class="nav">
								<li><a href="/SapeStore/manageInventory">Manage
										Inventory</a></li>

								<li><a href="/SapeStore/manageOrders">Manage Orders</a></li>

								<li class="active"><a href="/SapeStore/adminReport">Manage
										Reports</a></li>
				...
				<section style="height: 650px; margin-bottom: 20px;">
					...
					<div id="tabs" style="border: none; height: 650px;">
						<ul
							...
							<li><a href="/SapeStore/purchasedRentedReport"
								style="outline: none">Purchased/Rented</a></li>
							<li><a href="/SapeStore/defaultersReport"
								style="outline: none">Defaulters</a></li>
						</ul>
					</div>
