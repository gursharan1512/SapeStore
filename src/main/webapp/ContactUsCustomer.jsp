    ...
    <div id="header"> <a href="#" title="SapeStore" class="logo"><img src="img/logo_option 01.png" width="231" height="109" alt="SapeStore"></a>
     ...
     <%--  <nav>
        <ul class="nav">
					...
					<li><a href="/SapeStore/getBookSearchForm"><img alt="searchImage" src="img/magnifier-icon.png"></a></li>
					<c:choose>
      ...
      <nav>
				<ul class="nav">
					...
					<li><a id="header_account"
					 href="/SapeStore/editInfo">Account</a></li>
					</c:when>
					...
					<c:when test="${not empty userId}">
						...
						<li><a id="header_wishList"
						 href="displayWishList">Wishlist</a></li>
					...
					<c:otherwise>
							...
							<li><a id="header_wishList"
							 href="#login" class='inline' title="WishList" id="wishListPop" >Wishlist</a></li>
					</c:otherwise>
					</c:choose>
					...
					<li><a id="header_search"
					 href="/SapeStore/getBookSearchForm""><img alt="searchImage" src="img/magnifier-icon.png"></a></li>
...
<div id="contactDiv" style="margin-left:2px; margin-top: 25; margin-right: 20px">	<textarea id="contactText" name="contactText"  cols="40" rows="10" style="width: 698px;
	height: 755px;
	border-style: none;
